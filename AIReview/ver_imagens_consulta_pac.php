...
// Verificar se esta consulta pertence ao paciente
$query = "SELECT * FROM Consulta WHERE id_consulta = $id_consulta AND id_paciente = $id_paciente";
...
<body>
    ...
    <p><a href="dashboard_paciente.php">⬅ Voltar à dashboard</a></p>
</body>
</html>
